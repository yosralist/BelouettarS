        ...
        <div className="min-h-screen bg-white pt-24">
            ...
            <section ref={sectionRef} className="relative py-20 px-4 overflow-hidden">
                ...
                <div
                    ...
                    style={{
                        backgroundImage: 'url(/business-consulting-hero-img-bg.jpg)',
                        height: '120%',
                        top: '-10%',
                        left: 0,
                        right: 0
                ...
                <div className="relative max-w-6xl mx-auto text-center text-white">
                    ...
                    <p className="text-xl max-w-4xl mx-auto leading-relaxed">
                        We are here to support you in turning data into actionable decisions, innovative strategies, and successful outcomes. Get in touch with our team today.
                    </p>
                </div>
            </section>
                            ...
                            <div className="mb-8">
                                <div className="flex items-start gap-4 mb-6">
                                    <div className="flex-shrink-0 w-12 h-12 bg-[#2da5e5]/10 rounded-lg flex items-center justify-center">
                                        <svg className="w-6 h-6 text-[#2da5e5]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
